      ...
      "subjects": [
        {
          ...
          "series": [
            { "name": "Deforestation rate", "column": "units_km2_year",  "units": "km^2/year", "class": "line", "y_extent": [0,30000], "strokeColor": "#546DBC" }
          ]
        },
        {
          ...
          "x_axis": "date_processed",
          "series": [
            {"name": "Corn Prices", "column": "corn", "units": "BRL/Ton", "class": "line", "y_extent": [0,1100], "strokeColor": "#546DBC"},
            {"name": "Soybean Price", "column": "soybeans", "units": "BRL/Ton", "class": "line", "y_extent": [0,1100], "strokeColor": "#F0542C"}
          ]
        },
        {
          ...
          "x_axis": "years",
          "series": [
            {"name": "< 25 Hectares", "column": "_25_hectares", "units": "Index (2004=100)", "class": "line", "y_extent": [0,110], "strokeColor": "#546DBC"},
        ...
        },
        {
          ...
          "x_axis": "year",
          "series": [
          {"name": "Integral Protection", "column": "integral_protection", "units": "Thousand km^2", "class": "area", "y_extent": [0,1300], "strokeColor": "rgba(238,87,41,1)", "fillColor": "rgba(238,87,41,0.2)"},
            {"name": "Sustainable Use", "column": "sustainable_use", "units": "Thousand km^2", "class": "area", "y_extent": [0,1300], "strokeColor": "rgba(79,110,191,1)", "fillColor": "rgba(79,110,191,0.2)"},
        ...
        },
        {
          ...
          "description": "Test Diego",
          "units": "km2",
          "x_groups": [
            {"label": "1980-1990","column": "_1980_1990",},
            {"label": "1990-2000","column": "_1990_2000",},
            {"label": "2000-2010","column": "_2000_2010",},
          ...
          "series": [
            { "name": "Transmission", "strokeColor": "#546DBC" },
            { "name": "Nuclear", "strokeColor": "#546DBC" },
            { "name": "Non-hydro", "strokeColor": "#546DBC" },
          ]
        }
      ]
    },
